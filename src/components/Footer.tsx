...
const Footer: FC = () => {
  return (
    <div className="md:h-[60svh]  bg-[#383434] rubik pt-[3rem]  md:px-6 ">
      <section className="flex justify-center gap-[2rem] md:gap-[5rem]  xl:gap-[15rem] 2xl:gap-[15rem]">
        ...
        <article>
          <div>
            <form action="" className="md:flex gap-[1rem]">
              <input
                type="text"
                placeholder="Full Name"
                className="bg-[#FFFFFF33] md:w-[17rem] h-[2.5rem] md:h-[3.5rem] text-[#ccc] pl-1 border-none outline-none"
              />
              <input
                type="email"
                placeholder="Email"
                className="bg-[#FFFFFF33] md:w-[17rem] h-[2.5rem] mt-5 md:mt-5 md:h-[3.5rem] text-[#ccc] pl-1 border-none outline-none"
              />
            </form>
